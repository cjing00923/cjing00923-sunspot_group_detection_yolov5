...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='dataset/yolov5x.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'dataset/mydataset.yaml', help='dataset.yaml path')
